...
<div class="container-fluid">
    <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
            ...
            <form method="POST" class="needs-validation" novalidate action="{{route('events.update', ['id' => $events->id])}}">
                @csrf
                @method('PUT')
                <div class="row">
                    <div class="col-12 col-lg-4 mb-3">
                        ...
                        @if(!$errors->has('name'))
                        <input type="text"  class="form-control " id="inputName" name="name" placeholder="" value="{{$events->name}}">
                        @else
                ...
                <div class="row">
                    <div class="col-12 col-lg-4 mb-3">
                        ...
                        @if(!$errors->has('slug'))
                        <input type="text" class="form-control" id="inputSlug" name="slug" placeholder="" value="{{$events->slug}}">
                        @else
